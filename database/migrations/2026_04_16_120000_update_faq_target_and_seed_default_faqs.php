...
return new class extends Migration {
    ...
    public function down(): void
    {
        ...
        DB::table('faqs')
            ->whereIn('question', [
                'Apa itu aplikasi Buku Tamu Cadisdik XIII?',
                'Bagaimana alur kunjungan tamu?',
                'Bagaimana cara mencari data pengunjung?',
                'Apa yang bisa dikelola oleh Super Admin dan Kepala Cabang Dinas?',
                'Bagaimana cara mengelola FAQ?',
                'Apa tugas utama petugas Piket pada aplikasi ini?',
                'Bagaimana melihat riwayat pengunjung di panel Piket?',
                'Apa yang bisa dilakukan Staff pada modul kunjungan?',
                'Apakah Staff bisa melihat FAQ khusus?',
            ])
            ->delete();

        if (DB::getDriverName() === 'mysql') {
            DB::table('faqs')->where('target', 'staff')->update(['target' => 'semua']);
