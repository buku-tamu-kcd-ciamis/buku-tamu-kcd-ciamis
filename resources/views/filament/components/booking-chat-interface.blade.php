    ...
    <div class="booking-chat-shell">
        <aside class="booking-chat-sidebar">
            <div class="booking-chat-sidebar-head">
                ...
                <p class="booking-chat-sidebar-subtitle">Thread koordinasi dengan tim {{ $panelLabel }}.</p>
            </div>
            ...
            <div class="booking-chat-thread-list">
                ...
                @empty
                    <div class="booking-chat-empty-list">
                        <p>Belum ada thread chat booking.</p>
                        <p class="booking-chat-empty-hint">Thread akan otomatis muncul saat booking masuk ke staff.</p>
                    </div>
                @endforelse
            </div>
        </aside>
        ...
        >
            ...
            @else
                <div class="booking-chat-room-empty">
                    ...
                    <p>Pilih salah satu booking di panel kiri untuk mulai koordinasi chat.</p>
                </div>
            @endif
        </section>
    </div>
