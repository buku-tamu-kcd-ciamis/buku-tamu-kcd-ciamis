<div class="space-y-4">
    ...
    <div class="rounded-xl overflow-hidden border border-gray-200 dark:border-gray-600">
        {{-- Header dengan nama --}}
        <div class="bg-linear-to-r from-primary-500 to-primary-600 dark:from-primary-500 dark:to-primary-600 px-5 py-4">
        ...
        <div class="bg-white dark:bg-gray-900 divide-y divide-gray-100 dark:divide-gray-700/50">
            <div class="flex items-center gap-3 px-5 py-3">
                <div class="w-8 h-8 rounded-lg bg-blue-50 dark:bg-blue-500/20 flex items-center justify-center shrink-0">
            ...
            <div class="flex items-center gap-3 px-5 py-3">
                <div class="w-8 h-8 rounded-lg bg-emerald-50 dark:bg-emerald-500/20 flex items-center justify-center shrink-0">
            ...
            <div class="flex items-center gap-3 px-5 py-3">
                <div class="w-8 h-8 rounded-lg bg-purple-50 dark:bg-purple-500/20 flex items-center justify-center shrink-0">
    ...
    {{-- Total Kunjungan --}}
    <div class="flex items-center gap-4 p-4 rounded-xl bg-linear-to-r from-primary-50 to-primary-100 dark:from-primary-500/10 dark:to-primary-400/10 border border-primary-200 dark:border-primary-500/30">
        <div class="w-11 h-11 rounded-xl bg-primary-500 dark:bg-primary-500 flex items-center justify-center shrink-0 shadow-sm">
    ...
    <div>
        ...
        <div class="space-y-4 max-h-100 overflow-y-auto pr-1">
            ...
            <div class="relative flex gap-4">
                {{-- Timeline line --}}
                @if(!$loop->last)
                <div class="absolute left-3.25 top-8 -bottom-4 w-0.5 bg-gray-200 dark:bg-gray-600"></div>
                @endif
